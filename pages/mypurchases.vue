  ...
  <div class="bg-white">
    <div class="max-w-3xl mx-auto px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div class="mt-12 space-y-16 sm:mt-16">
        <section v-for="order in orders" :key="order.code" :aria-labelledby="`${order.code}-heading`">
          <div class="space-y-1 md:flex md:items-baseline md:space-y-0 md:space-x-4">
            <h2 :id="`${order.code}-heading`" class="text-lg font-medium text-gray-900 md:flex-shrink-0">Order #{{ order.code }}</h2>
